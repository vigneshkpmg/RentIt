...
import {
  ...
  orderStockRejected,
} from '../events/orderStockRejected'

class orderStatusChangedToPendingValidationHandler
  implements IIntegrationEventHandler<orderStatusChangedToPendingValidation>
{
