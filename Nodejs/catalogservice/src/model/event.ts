...
class IntegrationEventEntry{
     ...
     *
     */
    constructor( eventId:string, state:string = eventState.NotPublished.toString(), eventDetail:IIntegrationEvent, count:number=0) {
...
const integrationEventEntry = mongoose.model<IntegrationEventEntry>('IntegrationEventEntry', eventSchema);
